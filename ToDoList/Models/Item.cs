...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    public void Save()
    {
      ...
      cmd.ExecuteNonQuery();
      // Sets the Item's Id property equal to the value of the id of the new row in our database. 
      Id = (int) cmd.LastInsertedId;

      //Now our Save() method correctly saves an Item to the database and sets the 
      //Item's Id property to the database-assigned id value.
